...
void load_fiber_classes(py::module_ &m) {
    ...
    py::class_<ClassicFiberProp,FiberProp>(m, "ClassicFiberProp")
		.def("growing_speed",  [](ClassicFiberProp * prop) {return to_numpy(prop->growing_speed); })
		.def("growing_off_speed",  [](ClassicFiberProp * prop) {return to_numpy(prop->growing_off_speed);})
		.def("growing_force",  [](ClassicFiberProp * prop) {return to_numpy(prop->growing_force);})
		.def("shrinking_speed",  [](ClassicFiberProp * prop) {return to_numpy(prop->shrinking_speed);})
		.def("catastrophe_rate",  [](ClassicFiberProp * prop) {return to_numpy(prop->catastrophe_rate);})
		.def("catastrophe_rate_stalled",  [](ClassicFiberProp * prop) {return to_numpy(prop->catastrophe_rate_stalled);});
	
	py::class_<DynamicFiberProp,FiberProp>(m, "DynamicFiberProp")
		.def("growing_speed",  [](DynamicFiberProp * prop) {return to_numpy(prop->growing_speed); })
		.def("growing_off_speed",  [](DynamicFiberProp * prop) {return to_numpy(prop->growing_off_speed);})
		.def("growing_force",  [](DynamicFiberProp * prop) {return to_numpy(prop->growing_force);})
		.def("shrinking_speed",  [](DynamicFiberProp * prop) {return to_numpy(prop->shrinking_speed);});
